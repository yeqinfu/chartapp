...
package com.ppandroid.app.graphical.common;
...
public class DrawHelper {
	 ...
	 *            画笔
	 */
	public void drawTrigangle(float baseLine, float baseLnCentX, float baseLnCentY, XEnum.TriangleDirection direction, XEnum.TriangleStyle style, Canvas canvas, Paint paint) {
		// 计算偏移量
	...
	public void drawLine(XEnum.LineStyle style, float startX, float startY, float stopX, float stopY, Canvas canvas, Paint paint) {
	 ...
	 *             例外
	 */
	public void drawPercent(Canvas canvas, Paint paintArc, final float cirX, final float cirY, final float radius, final float startAngle, final float sweepAngle, boolean useCenter) throws Exception {
		try {
			initRectF();
	...
	public void drawPathArc(Canvas canvas, Paint paintArc, final float cirX, final float cirY, final float radius, final float startAngle, final float sweepAngle) throws Exception {
		try {
			initRectF();
			mRectF.left = cirX - radius;
			mRectF.top = cirY - radius;
