/*
 * Created by yeqinfu on 17-12-29 下午4:57
...
class AD_InstrumentWater(ac: Activity, list: List<BN_OverViewWater.MessageBean.InstrumentInfomationListBean>): PagerAdapter(){
    ...
    var list: List<BN_OverViewWater.MessageBean.InstrumentInfomationListBean>?=null
    ...
    class AD_List(ac: Activity, instrumentMapList: List<BN_OverViewWater.MessageBean.InstrumentInfomationListBean.InstrumentMapListBean>?) : BaseAdapter() {
        ...
        internal var instrumentMapList: List<BN_OverViewWater.MessageBean.InstrumentInfomationListBean.InstrumentMapListBean>?=null
        init {
            this.ac=ac
