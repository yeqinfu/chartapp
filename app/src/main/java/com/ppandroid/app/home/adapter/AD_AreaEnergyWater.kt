/*
 * Created by yeqinfu on 17-12-29 下午5:02
...
class AD_AreaEnergyWater(ac: Activity, list: List<BN_OverViewWater.MessageBean.OverviewConsumptionInformationBean.AreaInformationListBean>) : PagerAdapter() {
    ...
    var list: List<BN_OverViewWater.MessageBean.OverviewConsumptionInformationBean.AreaInformationListBean>? = null
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        list?.get(position)?.areaM3MapList?.let {
            if (it.size>0){
