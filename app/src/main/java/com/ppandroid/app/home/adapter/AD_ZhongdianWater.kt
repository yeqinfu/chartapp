/*
 * Created by yeqinfu on 17-12-29 下午4:55
...
class AD_ZhongdianWater(ac: Activity, list: List<BN_OverViewWater.MessageBean.DeviceInformationListBean>) : PagerAdapter() {
    ...
    var list: List<BN_OverViewWater.MessageBean.DeviceInformationListBean>? = null
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        ac?.let {
            var adapter = AD_List(it, list?.get(position)?.deviceM3MapList)
    ...
    class AD_List(ac: Activity, instrumentMapList: List<BN_OverViewWater.MessageBean.DeviceInformationListBean.DeviceM3MapListBean>?) : BaseAdapter() {
        ...
        internal var instrumentMapList: List<BN_OverViewWater.MessageBean.DeviceInformationListBean.DeviceM3MapListBean>? = null
