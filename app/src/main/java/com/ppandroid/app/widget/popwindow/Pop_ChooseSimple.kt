...
class Pop_ChooseSimple(context: Activity, data:ArrayList<String>): BasePopupWindow(context, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT) {
    ...
    override fun onCreatePopupView(): View {
        return createPopupById(R.layout.pop_choose_diary)
    }
