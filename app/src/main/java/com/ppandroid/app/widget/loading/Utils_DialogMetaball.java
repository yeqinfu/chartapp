/*
 * Created by yeqinfu on 18-1-12 上午11:11
 * Copyright (c) JXT All rights reserved.
 */

package com.ppandroid.app.widget.loading;
...
public class Utils_DialogMetaball {
    ...
    public static Dialog createLoadingDialog(Context context, String msg) {
        ...
        View v = inflater.inflate(R.layout.dialog_loading_metaball, null);// 得到加载view
        MetaballView metaballView = (MetaballView) v.findViewById(R.id.metaball);
