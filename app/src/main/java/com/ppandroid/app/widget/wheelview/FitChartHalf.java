...
public class FitChartHalf extends View {
    ...
    /**开始位置 这个类就改了这个变量，开始角度，还有结束的位置*/
    static final float MAXIMUM_SWEEP_ANGLE = 280f;
    static final int START_ANGLE = 130;
    ...
    private void renderBack(Canvas canvas) {
        ...
        path.addArc(drawingArea, START_ANGLE, MAXIMUM_SWEEP_ANGLE);
    ...
    private float calculateSweepAngle(float value) {
        ...
        //这边按照设定比例计算扫描角度
        float chartValuesScale = (MAXIMUM_SWEEP_ANGLE / chartValuesWindow);
